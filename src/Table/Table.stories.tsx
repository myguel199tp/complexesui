...
export const WithWiderColumns: Story = {
  args: {
    ...
    rows: [
      ...
      [
        "Another wide value example with long text",
        "Short",
        "123",
      ...
      [
        "This row tests text wrapping behavior",
        "Column 2 data",
        "Column 3 data",
        "Column 4 data",
        "Column 5 data",
      ...
      ["Row 4 Wide", "C2", "C3", "C4", "C5", "C6", "C7", "C8", "C9", "C10"],
    ],
    cellClasses: [
      [
        "w-[220px]",
    ...
    actions: [
      {
        label: "Editar",
        icon: "✏️",
        onClick: (rowIndex: number) => alert(`Editar fila ${rowIndex + 1}`),
      },
      {
        label: "Eliminar",
        icon: "🗑️",
        onClick: (rowIndex: number) => alert(`Eliminar fila ${rowIndex + 1}`),
      },
    ],
  },
};
